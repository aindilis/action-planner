...
when I initially tell the AI that I need to tell the doctor X
 (agent that plans over communication and world knowledge)
 )
...
(Need to find software for managing all assertions to the KB, all
 unilang entries, etc, to be able to search)
(need to be able to record goals, and need semantics of various
 goals Epistemic Action Logic)
